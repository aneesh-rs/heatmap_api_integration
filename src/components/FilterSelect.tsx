...
const FilterSelect: React.FC<FilterSelectProps> = ({ categories, selectedFilters, setSelectedFilters }) => {
    ...
    return (
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg w-full max-w-2xl">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6">
                Filtros: <span className="font-semibold text-gray-600">Selección múltiple</span>
            </h1>
